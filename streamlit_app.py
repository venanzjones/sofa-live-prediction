...
def predict_sofa_score(weight, height, sofascore):
...
with st.sidebar:
    ...
    sofascore = st.number_input('Sofa Score', min_value=0, max_value=20, value=5, step=1)

# Predict Sofa Score for the following day
predicted_score = predict_sofa_score(weight, height, sofascore)

# Display predicted Sofa Score
st.subheader('Predicted Sofa Score for the Following Day')
